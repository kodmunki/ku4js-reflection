$(function() {
    ...
    test("toFunction", function () {
        var block1 = $.ku4block("function(x){ return x + 1 }"),
    ...
    test("execute multiple argument", function () {
        var block1 = $.ku4block("function(x, y, z, zzz){ return [x + 1, y, z, zzz]; }"),
    ...
    test("execute multiple argument tight", function () {
        var block1 = $.ku4block("function(zz,z,zzzzz,zzz){ return [zzz,z,zz,zzzzz]; }"),
    ...
    test("execute complex function with simple arguments", function () {
        var block1 = $.ku4block("function(x, y, z){ return $.money(x).add($.money(y)).value() / z; }"),
    ...
    test("execute complex function with simple arguments", function () {
        var block1 = $.ku4block("function(xxxx, yyyy, zzzz){ return $.money(xxxx).add($.money(yyyy)).value() / zzzz * zzzz; }"),
    ...
    test("execute complex function with commonn name arguments", function () {
        var block1 = $.ku4block("function(other, multiplier){ return $.money(4.15).add(other).multiply(multiplier); }"),
    ...
    test("execute complex function with no arguments", function () {
        var block1 = $.ku4block("function(){ return 1; }"),
    ...
    test("execute block with self executing function", function () {
        var block1 = $.ku4block("function (){ return (function(x){ return x+1 })(1) }"),
